      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="text-center mb-14 sm:mb-20">
          <div className="inline-flex items-center justify-center gap-3 mb-6">
            <span className="h-px w-10 bg-[#b89d64]" />
            <span className="grid place-items-center w-14 h-14 rounded-full bg-[#1a3d2e] text-[#b89d64] ring-2 ring-[#b89d64]/30">
              <SproutMark className="w-7 h-7" />
            </span>
            <span className="h-px w-10 bg-[#b89d64]" />
          </div>
          <h1 className="font-heading font-bold text-[#1a3d2e] text-4xl sm:text-6xl lg:text-7xl tracking-tight">
            IRIS ALIBERTI
          </h1>
          <p className="mt-3 text-xs sm:text-sm tracking-[0.45em] text-[#1a3d2e]/70 font-medium uppercase">
            Engenheira Agrônoma
          </p>
          <p className="mt-4 font-script text-2xl sm:text-3xl text-[#b89d64]">
        ...
        <div className="grid lg:grid-cols-[1.15fr_0.85fr] gap-10 lg:gap-14 items-stretch">
          {/* Left: services list */}
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl border border-[#b89d64]/25 p-7 sm:p-10 shadow-[0_20px_60px_-30px_rgba(26,61,46,0.35)]">
            <ul className="space-y-7">
              {services.map((s, i) => (
                <li key={s.title} className="flex gap-4 group">
                  <span className="shrink-0 grid place-items-center w-12 h-12 rounded-full bg-[#1a3d2e] text-white transition-transform group-hover:scale-110 shadow-md">
                    <s.icon className="w-5 h-5" strokeWidth={1.8} />
                  </span>
                  <div className="pt-0.5">
                    <h3 className="font-heading font-semibold text-[#1a3d2e] text-base sm:text-lg leading-snug">
                      {s.title.toUpperCase()}
                    </h3>
            ...
            <a
              ...
              className="mt-9 inline-flex items-center gap-2 rounded-full bg-[#1a3d2e] text-[#fdfcf9] px-7 py-3.5 text-sm font-semibold hover:bg-[#244d3b] transition-all hover:gap-3 shadow-lg shadow-[#1a3d2e]/20"
            >
          ...
          {/* Right: visual panel */}
          <div className="relative rounded-3xl overflow-hidden min-h-[420px] lg:min-h-full shadow-[0_30px_80px_-30px_rgba(26,61,46,0.5)]">
            <Image
              src={HERO_IMG}
            ...
            <div className="relative h-full flex flex-col justify-end p-7 sm:p-9">
              <div className="bg-[#1a3d2e]/85 backdrop-blur-md rounded-2xl p-6 ring-1 ring-[#b89d64]/30">
                <p className="font-script text-2xl text-[#b89d64] leading-none">
                  Soluções completas
                </p>
                <p className="mt-3 text-[#fdfcf9] text-sm font-semibold tracking-wide leading-relaxed">
