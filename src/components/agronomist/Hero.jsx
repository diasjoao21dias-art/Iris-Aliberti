...
export default function Hero() {
  return (
    <section id="inicio" className="relative pt-24 sm:pt-36 pb-14 sm:pb-28 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="text-center mb-10 sm:mb-20">
          <div className="inline-flex items-center justify-center gap-3 mb-5">
            ...
            <span className="grid place-items-center w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-[#1a3d2e] text-[#b89d64] ring-2 ring-[#b89d64]/30">
              <SproutMark className="w-6 h-6 sm:w-7 sm:h-7" />
            </span>
            <span className="h-px w-8 sm:w-10 bg-[#b89d64]" />
          </div>
          <h1 className="font-heading font-bold text-[#1a3d2e] text-3xl sm:text-6xl lg:text-7xl tracking-tight">
            IRIS ALIBERTI
          </h1>
          <p className="mt-2 sm:mt-3 text-[11px] sm:text-sm tracking-[0.4em] sm:tracking-[0.45em] text-[#1a3d2e]/70 font-medium uppercase">
            Engenheira Agrônoma
          </p>
          <p className="mt-3 sm:mt-4 font-script text-xl sm:text-3xl text-[#b89d64]">
        ...
        <div className="grid lg:grid-cols-[1.15fr_0.85fr] gap-6 sm:gap-10 lg:gap-14 items-stretch">
          {/* Left: services list */}
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl border border-[#b89d64]/25 p-5 sm:p-10 shadow-[0_20px_60px_-30px_rgba(26,61,46,0.35)]">
            ...
            <a
              ...
              className="mt-6 sm:mt-9 inline-flex items-center gap-2 rounded-full bg-[#1a3d2e] text-[#fdfcf9] px-6 sm:px-7 py-3 sm:py-3.5 text-sm font-semibold hover:bg-[#244d3b] transition-all hover:gap-3 shadow-lg shadow-[#1a3d2e]/20"
            >
          ...
          {/* Right: visual panel */}
          <div className="relative rounded-3xl overflow-hidden min-h-[320px] sm:min-h-[420px] lg:min-h-full shadow-[0_30px_80px_-30px_rgba(26,61,46,0.5)]">
            <Image
              src={HERO_IMG}
